...
namespace Q_Medic_Hospital {
    ...
    public class MiddleWare {
        ...
        static String root = Path.GetDirectoryName(Application.ExecutablePath);
        ...
        public SqlConnection dbConnection = new SqlConnection("Data Source=(LocalDB)\\v11.0;AttachDbFilename=" + root + "\\INB201.mdf;Integrated Security=True");  // MDF file
